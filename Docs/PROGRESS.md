...
- **Milestone 6: Reworked Webapp**
  ...
  - **Description**: Rewrote the core features of MetalSlugFontReborn webapp version, improving performance, functionality, and compatibility. [MetalSlugFontRebornWeb](https://github.com/VermeilChan/MetalSlugFontRebornWeb)
